...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">พันธกิจ / เป้าหมาย</h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="../index.php">หน้าแรก</a>
      </li>
      <li class="breadcrumb-item active">พันธกิจ - เป้าหมาย</li>
    </ol>

    <h2>พันธกิจ</h2>
    <ul>
      <li>พัฒนาคุณภาพของโรงเรียนและนักเรียนให้ได้ตามมาตรฐานและคุณภาพ</li>
      <li>นักเรียนมีทักษะพื้นฐานในการใช้เทคโนโลยีเพื่อการเรียนรู้และการทำงานร่วมกับผู้อื่นได้</li>
      <li>นักเรียนสามารถดำเนินชีวิตตามหลักเศรษฐกิจพอเพียง รู้รักษาและเชิดชูวัฒนธรรมไทย</li>
      <li>ส่งเสริมให้ชุมชนมีส่วนร่วมในการพัฒนาการศึกษา</li>
    </ul>

    <h2>เป้าหมาย</h2>
    <ul>
      <li>นักเรียนมีความรู้และพัฒนาการด้านการเรียนรู้ตามเกณฑ์มาตรฐาน</li>
      <li>นักเรียนสามารถใช้เทคโนโลยีที่ทันสมัยในการเรียนรู้และทำงานร่วมกับผู้อื่นได้</li>
      <li>นักเรียนสามารถดำเนินชีวิตตามหลักเศรษฐกิจพอเพียง รู้รักษาและเชิดชูวัฒนธรรมไทย</li>
