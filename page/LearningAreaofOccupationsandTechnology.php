...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">กลุ่มสาระฯการงานอาชีพฯ</h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="../index.php">หน้าแรก</a>
      </li>
      <li class="breadcrumb-item active">กลุ่มสาระฯการงานอาชีพฯ</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="../Img/Thidatip.jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">นางสาวธิดาทิพย์ ทุมวัน</a>
            </h4>
