...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">กลุ่มสาระฯวิทยาศาสตร์</h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="../index.php">หน้าแรก</a>
      </li>
      <li class="breadcrumb-item active">กลุ่มสาระฯวิทยาศาสตร์</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-4 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">นางนันธิดา วิรุฬพัฒน์</a>
            </h4>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-4 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">นางสาวทิวาภรณ์ อักษรพิมพ์</a>
            </h4>
