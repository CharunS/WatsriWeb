...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">สัญลักษณ์โรงเรียน</h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="../index.php">หน้าแรก</a>
      </li>
      <li class="breadcrumb-item active">สัญลักษณ์</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="../Img/Shcool_Logo.png" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3" style="text-align: center;">อักษรย่อประจำโรงเรียน</h3>
        <p style="text-align: center;">ก</p>
        <p style="text-align: center;">บน. ศร.</p>       
      </div>
