...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">ปฐมวัย</h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="../index.php">หน้าแรก</a>
      </li>
      <li class="breadcrumb-item active">ปฐมวัย</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="#" style="font-size: large;">นางสาววิภารัตน์ เหลื่อมทองหลาง</a>
            </h4>
            <p class="card-text">ครู รับเงินเดือนอันดับ ครู คศ.๑</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6 portfolio-item">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">นางสาวปวีณา เขตรสาลี</a>
            </h4>
            <p class="card-text">พี่เลี้ยง ส ๑</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">นางสาวกัญญาณัช มีมังคละ</a>
            </h4>
            <p class="card-text">พี่เลี้ยง ส ๑</p>
          </div>
        </div>
