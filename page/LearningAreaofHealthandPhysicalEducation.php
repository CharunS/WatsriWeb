...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">กลุ่มสาระฯสุขศึกษาฯ</h1>

    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="../index.php">หน้าแรก</a>
      </li>
      <li class="breadcrumb-item active">กลุ่มสาระฯสุขศึกษาฯ</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          <a href="#"><img class="card-img-top" src="../Img/Phidsanu.jpg" alt=""></a>
          <div class="card-body">
            <h4 class="card-title">
              <a href="#">นายพิษณุ ณ พัทลุง</a>
            </h4>
            <p class="card-text">ครู รับเงินเดือนอันดับ คศ.๑</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6 portfolio-item">
